---
name: creating-pr
description: Create a clean, review-ready pull request with a good title, structured description, linked issues, and appropriate reviewers. Use when packaging work into a PR, pushing changes for review, or when the user asks to create or open a pull request.
