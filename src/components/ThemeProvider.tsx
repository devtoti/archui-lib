...
import doricIcon from "../assets/icons/doric.svg?url";
import ionicIcon from "../assets/icons/ionic.svg?url";
import corinthianIcon from "../assets/icons/corinthian.svg?url";
