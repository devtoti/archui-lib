    ...
    >
      ...
      <div className="dropdown-container relative w-full h-80 bg-sys-surface-secondary relative z-10">
        <Button
          ...
          className="absolute top-4 right-1/2 transform translate-x-1/2 translate-y-1/2"
        />
        <div
          className="navigation-menu absolute top-1/2 right-4 transform -translate-y-1/2 bg-sys-surface-white flex flex-col gap-sys-sp-sm items-start px-4 w-56 md:px-sys-pd-lg py-sys-pd-sm md:py-sys-pd-md rounded-lg shadow-md"
        ...
        {activeDropdown === 'themes' && (
          <div
            className="dropdown-menu-orders absolute bg-sys-surface-white flex flex-col gap-sys-sp-sm h-auto md:h-[140px] items-start px-sys-pd-sm md:px-sys-pd-lg py-2 rounded-lg shadow-md top-1/2 right-62 transform -translate-y-1/5 w-[160px] md:w-[196.2px] text-xs md:text-sm z-20 transition-opacity duration-200"
            onMouseEnter={() => handleDropdownShow('themes')}
            onMouseLeave={handleDropdownHideWithDelay}
          >
            <div
        ...
        {activeDropdown === 'colors' && (
          <div
            className="dropdown-menu-colors absolute bg-sys-surface-white flex flex-col gap-sys-sp-sm h-24 items-start px-sys-pd-sm md:px-sys-pd-lg py-sys-pd-sm md:py-sys-pd-md rounded-lg shadow-md top-1/2 right-62 transform -translate-y-1/2 w-[160px] md:w-[196.2px] text-xs md:text-sm z-20 transition-opacity duration-200"
            onMouseEnter={() => handleDropdownShow('colors')}
            onMouseLeave={handleDropdownHideWithDelay}
          >
            <div
