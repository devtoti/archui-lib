import{u as o,j as e,M as r,S as t}from"./iframe-CD6aicnh.js";import"./preload-helper-By1u-41e.js";function i(s){const n={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",h4:"h4",p:"p",strong:"strong",...o(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"00 GETTING STARTED/Library Setup"}),`
...
`,e.jsx("aside",{style:{marginTop:"2rem",marginBottom:"2rem",padding:"1.5rem",backgroundColor:"var(--bg-warning-light, #fef3c7)",borderRadius:"8px",border:"1px solid var(--brd-warning, #fbbf24)",color:"var(--sem-text-warning, #b78100)"},children:e.jsxs(n.p,{children:["💡 ",e.jsx("strong",{children:"Inspiration & Acknowledgment"}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Excited to have you with us!"})," Browse the component library in the sidebar to see what ArchUI can do for your project."]})]})}function c(s={}){const{wrapper:n}={...o(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(i,{...s})}):i(s)}export{c as default};
