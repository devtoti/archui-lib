import{r as n,j as e,u,M as y}from"./iframe-BR1oeFPx.js";import{g as c}from"./paths-BxFImlO9.js";import"./preload-helper-By1u-41e.js";const p=({src:r,width:t="800",height:i="450"})=>{const[d,l]=n.useState(!0),[f,o]=n.useState(!1),s=n.useRef(null);n.useEffect(()=>{const b=setTimeout(()=>{d&&l(!1)},5e3);return()=>clearTimeout(b)},[d]);const a=()=>{l(!1)},h=()=>{l(!1),o(!0)};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        ...
        `}),e.jsxs("div",{className:"figma-embed-container",children:[d&&e.jsx("div",{className:"h-full w-full flex items-center justify-center figma-embed-skeleton","aria-label":"Loading ArchUI Figma Component Kit"}),f?e.jsxs("div",{className:"figma-embed-error",children:[e.jsx("div",{className:"figma-embed-error-icon",children:"⚠️"}),e.jsx("div",{className:"figma-embed-error-text",children:"Failed to load Figma embed"}),e.jsx("div",{className:"figma-embed-error-subtext",children:"Please check your connection or try refreshing the page"})]}):e.jsx("iframe",{ref:s,className:"figma-embed-iframe",src:r,width:t,height:i,allowFullScreen:!0,title:"Figma Design System Embed",onLoad:a,onError:h,loading:"lazy"})]})]})};p.__docgenInfo={description:"",methods:[],displayName:"FigmaEmbed",props:{src:{required:!0,tsType:{name:"string"},description:""},width:{required:!1,tsType:{name:"union",raw:"string | number",elements:[{name:"string"},{name:"number"}]},description:"",defaultValue:{value:'"800"',computed:!1}},height:{required:!1,tsType:{name:"union",raw:"string | number",elements:[{name:"string"},{name:"number"}]},description:"",defaultValue:{value:'"450"',computed:!1}}}};const m=[{src:c("/icons/models/thumb5.png"),alt:"Screenshot 5",style:{height:"180px",flex:"1 1 120px",minWidth:"80px",maxWidth:"200px",objectFit:"cover",borderRadius:"8px",boxShadow:"0 2px 8px rgba(0,0,0,0.04)",width:"100%"}},{src:c("/icons/models/thumb4.png"),alt:"Screenshot 4",style:{height:"140px",flex:"1 1 120px",minWidth:"80px",maxWidth:"200px",objectFit:"cover",borderRadius:"8px",boxShadow:"0 2px 8px rgba(0,0,0,0.04)",width:"100%"}},{src:c("/icons/models/thumb3.png"),alt:"Screenshot 3",style:{height:"180px",flex:"1 1 120px",minWidth:"80px",maxWidth:"200px",objectFit:"cover",borderRadius:"8px",boxShadow:"0 2px 8px rgba(0,0,0,0.04)",width:"100%"}},{src:c("/icons/models/thumb2.png"),alt:"Screenshot 2",style:{height:"140px",flex:"1 1 120px",minWidth:"80px",maxWidth:"200px",objectFit:"cover",borderRadius:"8px",boxShadow:"0 2px 8px rgba(0,0,0,0.04)",width:"100%"}},{src:c("/icons/models/thumb1.png"),alt:"Screenshot 1",style:{height:"240px",flex:"1 1 140px",minWidth:"100px",maxWidth:"250px",objectFit:"cover",borderRadius:"8px",boxShadow:"0 2px 8px rgba(0,0,0,0.04)",width:"100%"}}],x=()=>{const[r,t]=n.useState(null),i=n.useRef(null),d=n.useRef(null);n.useEffect(()=>(r!==null?document.body.style.overflow="hidden":document.body.style.overflow="",()=>{document.body.style.overflow=""}),[r]),n.useEffect(()=>{if(r===null)return;const o=s=>{s.key==="Escape"?t(null):s.key==="ArrowLeft"?t(a=>a===null||a===0?m.length-1:a-1):s.key==="ArrowRight"&&t(a=>a===null?null:a===m.length-1?0:a+1)};return window.addEventListener("keydown",o),()=>window.removeEventListener("keydown",o)},[r]);const l=()=>{t(o=>o===null||o===0?m.length-1:o-1)},f=()=>{t(o=>o===null?null:o===m.length-1?0:o+1)};return n.useEffect(()=>{},[r]),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
          .figma-screenshots {
            display: flex;
            gap: 0.5rem;
...
`,e.jsx(x,{})]})}function k(r={}){const{wrapper:t}={...u(),...r.components};return t?e.jsx(t,{...r,children:e.jsx(g,{...r})}):g(r)}export{k as default};
